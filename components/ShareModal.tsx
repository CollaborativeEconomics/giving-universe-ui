...
import { Share as IconShare } from 'lucide-react'
          ...
          <div className="w-full mx-0 p-0 rounded-xl">
            <div className="my-4">
              ...
              <div className="flex flex-col justify-between items-center mt-4 py-0">
                <input id="copyurl" className="w-full outline-none border-0 bg-transparent text-sm" type="text" placeholder="link" value={url} />
                <button className="bg-indigo-500 text-white rounded text-sm py-2 px-5 mt-2 hover:bg-indigo-600" onClick={copyToClipboard}>Copy</button>
              </div>
            </div>
          </div>
        </div>
