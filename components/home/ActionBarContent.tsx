...
const ActionBarBox = React.forwardRef<HTMLDivElement, ActionBarBoxProps>(
  ({ className, ...props }, ref) => {
    return (
      <div
        className={cn(
          'flex flex-col container py-8 gap-3 w-[45%] max-w-[700px] hover:bg-slate-500 duration-200 text-white bg-opacity-20 text-center items-center justify-center m-0',
          className
        )}
        ref={ref}
        {...props}
